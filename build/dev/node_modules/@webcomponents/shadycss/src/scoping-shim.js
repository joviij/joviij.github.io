...
export default class ScopingShim {
  ...
  _reorderCustomStylesRules(customStyles) {
    const styles = customStyles.map(c => this._customStyleInterface['getStyleForCustomStyle'](c)).filter(s => !!s); // sort styles in document order
